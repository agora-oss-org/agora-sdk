 ...
 *
 * Opens the Replyke-brokered provider consent screen in the system browser via
 * `expo-web-browser` and receives the result through a custom-scheme deep link.
 * API-compatible with the web `@agora-sdk/react-js` hook, with two mobile deltas:
